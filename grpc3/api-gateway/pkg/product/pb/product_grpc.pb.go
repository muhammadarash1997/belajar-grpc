...
type ProductServiceClient interface {
	...
	DecreaseStock(ctx context.Context, in *DescreaseStockRequest, opts ...grpc.CallOption) (*DescreaseStockResponse, error)
}
...
func (c *productServiceClient) DecreaseStock(ctx context.Context, in *DescreaseStockRequest, opts ...grpc.CallOption) (*DescreaseStockResponse, error) {
	out := new(DescreaseStockResponse)
...
type ProductServiceServer interface {
	...
	DecreaseStock(context.Context, *DescreaseStockRequest) (*DescreaseStockResponse, error)
...
func (UnimplementedProductServiceServer) DecreaseStock(context.Context, *DescreaseStockRequest) (*DescreaseStockResponse, error) {
...
func _ProductService_DecreaseStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).DecreaseStock(ctx, req.(*DescreaseStockRequest))
	}
	return interceptor(ctx, in, info, handler)
}
