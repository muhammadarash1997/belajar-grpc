...
type DescreaseStockRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DescreaseStockRequest) Reset() {
	*x = DescreaseStockRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *DescreaseStockRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DescreaseStockRequest) ProtoMessage() {}

func (x *DescreaseStockRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_product_pb_product_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DescreaseStockRequest.ProtoReflect.Descriptor instead.
func (*DescreaseStockRequest) Descriptor() ([]byte, []int) {
	return file_pkg_product_pb_product_proto_rawDescGZIP(), []int{5}
}

func (x *DescreaseStockRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *DescreaseStockRequest) GetOrderId() int64 {
	if x != nil {
		return x.OrderId
	}
	return 0
...
type DescreaseStockResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DescreaseStockResponse) Reset() {
	*x = DescreaseStockResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *DescreaseStockResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DescreaseStockResponse) ProtoMessage() {}

func (x *DescreaseStockResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_product_pb_product_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DescreaseStockResponse.ProtoReflect.Descriptor instead.
func (*DescreaseStockResponse) Descriptor() ([]byte, []int) {
	return file_pkg_product_pb_product_proto_rawDescGZIP(), []int{6}
}

func (x *DescreaseStockResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *DescreaseStockResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x41, 0x0a, 0x15, 0x44, 0x65, 0x73, 0x63, 0x72, 0x65,
	...
	0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x46, 0x0a, 0x16, 0x44, 0x65, 0x73,
	...
	0x74, 0x2e, 0x44, 0x65, 0x73, 0x63, 0x72, 0x65, 0x61, 0x73, 0x65, 0x53, 0x74, 0x6f, 0x63, 0x6b,
...
var file_pkg_product_pb_product_proto_goTypes = []interface{}{
	...
	(*DescreaseStockRequest)(nil),  // 5: product.DescreaseStockRequest
	(*DescreaseStockResponse)(nil), // 6: product.DescreaseStockResponse
}
var file_pkg_product_pb_product_proto_depIdxs = []int32{
	...
	5, // 3: product.ProductService.DecreaseStock:input_type -> product.DescreaseStockRequest
	...
	6, // 6: product.ProductService.DecreaseStock:output_type -> product.DescreaseStockResponse
...
func file_pkg_product_pb_product_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_product_pb_product_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DescreaseStockRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pkg_product_pb_product_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DescreaseStockResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
